...
import com.itismob.s16.group4mco.databinding.ActivityLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginBtn.setOnClickListener {
            ...
            if (email.isEmpty() || password.isEmpty()) {
                ...
                Toast.makeText(this, "The email and/or password you typed in are incorrect.", Toast.LENGTH_SHORT).show()
            }
        }
